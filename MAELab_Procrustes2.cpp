...
vector<Point> extract_Contours(Matrix<int> mapContours) {
	...
	cout << "\nNumber of mean curve points: " << ctPoints.size();
	return ctPoints;
}
/*
...
int main(int argc, char* argv[]) {
	...
	// Display the segmentation result on the images
	/*string imagePath =
	 "/home/linhpc/data_CNN/linhlv/pronotum/v1/original/Prono_001.JPG";
	 string savefile = "/home/linhpc/abc.jpg";
	 if(argc == 3){
	 imagePath = argv[1];
	 savefile = argv[2];
	 }
	 cout<<"Parameters: " <<argc;
	 Image matImage(imagePath);
	 vector<Point> cPoints = mae_Canny_Algorithm(&matImage);
...
// ================================================================================================
	...
	/*string imagePath =
	 "/home/linhpc/data_CNN/linhlv/pronotum/v1/original/Prono_001.JPG";
	 string lmPath =
	 "/home/linhpc/data_CNN/linhlv/pronotum/v1/landmarks/p_001.TPS";
	 int lmIndex = 2;
	 string fSave =
	 "/home/linhpc/Results/2018/pronotum/procrustes/landmark_3/";
	 int bsize = 7;
	 if (argc == 6)
	 {
	 cout << "\nWith parameters...";
...
// ================================================================================================
	/*
	 * Improving the location of predicted landmarks
	 */
	...
	string fileName =
			"/home/linhpc/Results/2018/pronotum/procrustes/landmark_4/Prono_005.txt";
	Matrix<int> pMatrix = parse_Matrix_From_File(fileName);
	 ...
	 */
	string imagePath =
			"/home/linhpc/data_CNN/linhlv/pronotum/v1/original/Prono_010.JPG";
	Image image(imagePath);
	Point estLandmark(237, 168);
	//vector < vector<Point> > pPoints = extract_Shape_Manual_Landmark(image,
	//		estLandmark, 12, 7);
	vector<vector<Point> > points = extract_Shape_Predicted_Landmark(image,
			estLandmark, 12, 7);
