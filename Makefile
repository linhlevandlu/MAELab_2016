...
# Generated by qmake (2.01a) (Qt 4.8.7) on: jeu. juin 28 22:03:05 2018
...
SOURCES       = io/JPEGReader.cpp \
		...
		ui/ImageViewer.cpp \
		MAELab.cpp \
		MAELab_PostCNN.cpp moc_ImageViewer.cpp
...
MAELab_PostCNN.o: MAELab_PostCNN.cpp imageModel/Point.h \
		imageModel/Line.h \
		imageModel/Edge.h \
		imageModel/Matrix.h \
		imageModel/Image.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MAELab_PostCNN.o MAELab_PostCNN.cpp
