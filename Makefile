...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Jul 28 17:06:35 2018
...
SOURCES       = io/JPEGReader.cpp \
		...
		ui/ImageViewer.cpp \
		MAELab.cpp \
		MAELab_PostCNN2.cpp moc_ImageViewer.cpp
...
MAELab_PostCNN2.o: MAELab_PostCNN2.cpp imageModel/Point.h \
		imageModel/Line.h \
		imageModel/Edge.h \
		imageModel/Matrix.h \
		imageModel/Image.h \
		...
		pointInterest/LandmarkDetection.h \
		MAELab.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MAELab_PostCNN2.o MAELab_PostCNN2.cpp
