...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ven. janv. 13 17:01:26 2017
...
SOURCES       = MAELab_CI.cpp \
		...
		ui/ImageViewer.cpp \
		MAELab.cpp moc_ImageViewer.cpp
OBJECTS       = MAELab_CI.o \
		JPEGReader.o \
		Reader.o \
		TPSReader.o \
...
Texture.o: segmentation/Texture.cpp imageModel/Point.h \
		imageModel/Matrix.h \
		segmentation/Texture.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Texture.o segmentation/Texture.cpp
