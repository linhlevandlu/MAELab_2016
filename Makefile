...
# Generated by qmake (2.01a) (Qt 4.8.6) on: lun. nov. 13 15:19:56 2017
...
SOURCES       = io/JPEGReader.cpp \
		...
		ui/ImageViewer.cpp \
		MAELab.cpp \
		MAELab_Procrustes.cpp moc_ImageViewer.cpp
...
MAELab_Procrustes.o: MAELab_Procrustes.cpp imageModel/Point.h \
		imageModel/Line.h \
		imageModel/Edge.h \
		imageModel/Matrix.h \
		imageModel/Image.h \
		...
		pointInterest/LandmarkDetection.h \
		MAELab.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MAELab_Procrustes.o MAELab_Procrustes.cpp
